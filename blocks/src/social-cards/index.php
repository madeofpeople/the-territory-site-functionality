...
function social_sharing_link_services( $service = '', $post_id = null ) {
	...
	$services_data = array(
		...
		'sms'       => array(
			...
			'url'   => 'sms:?&body=' . $card_title . ' - ' . $permalink,
		...
		'twitter'   => array(
			'label' => __( 'Share ' . $title . ' on Twitter', 'site-functionality' ),
		...
		'instagram' => array(
			'label' => __( 'View ' . $card_title . ' on Instagram', 'site-functionality' ),
		...
		'download'  => array(
			'label' => __( 'Download ' . $card_title . ' images as a File', 'site-functionality' ),
